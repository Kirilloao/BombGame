...
class SettingsCell: UITableViewCell {
  ...
  private func setupConstraints() {
    NSLayoutConstraint.activate([
      ...
      mainLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 0),
      mainLabel.leadingAnchor.constraint(equalTo: circleView.trailingAnchor, constant: 10),
