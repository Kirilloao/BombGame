...
class CustomButtonCell: UITableViewCell {
  ...
  private func setupConstraints() {
    NSLayoutConstraint.activate([
      numberView.topAnchor.constraint(equalTo: contentView.topAnchor, constant: 5),
      numberView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 20),
      ...
      ruleLabel.topAnchor.constraint(equalTo: numberView.topAnchor, constant: 5),
      ruleLabel.leadingAnchor.constraint(equalTo: numberView.trailingAnchor, constant: 10),
      ruleLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -30),
      ruleLabel.bottomAnchor.constraint(equalTo: startButton.topAnchor, constant: -5),
      
      startButton.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -5),
